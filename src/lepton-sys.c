...
{
  uint32_t uptime = 0;
  ((struct lepton_driver*)driver)->communication.receiveCommand_u32(cmdCode(LEP_CID_SYS_CAM_UPTIME, LEP_I2C_COMMAND_TYPE_GET),
...
{
  ((struct lepton_driver*)driver)->communication.sendCommand_raw(cmdCode(LEP_CID_SYS_RUN_FFC, LEP_I2C_COMMAND_TYPE_RUN),&(((struct lepton_driver*)driver)->communication));
}
...
{
  ((struct lepton_driver*)driver)->communication.sendCommand_raw(cmdCode(LEP_CID_SYS_PING, LEP_I2C_COMMAND_TYPE_RUN),&(((struct lepton_driver*)driver)->communication));
}
...
{
  ((struct lepton_driver*)driver)->communication.sendCommand_raw(cmdCode
...
void sys_setSceneRegion(LEP_SYS_SCENE_ROI * region, void * driver)
{
  if (!region)
    return;
  ((struct lepton_driver*)driver)->communication.sendCommand_array(cmdCode(LEP_CID_SYS_SCENE_ROI, LEP_I2C_COMMAND_TYPE_SET),
...
void sys_getSceneRegion(LEP_SYS_SCENE_ROI * region, void * driver)
{
  if (!region)
    return;
  ((struct lepton_driver*)driver)->communication.receiveCommand_array(cmdCode(LEP_CID_SYS_SCENE_ROI, LEP_I2C_COMMAND_TYPE_GET),
                       (uint16_t *) region, sizeof(LEP_SYS_SCENE_ROI) / 2,&(((struct lepton_driver*)driver)->communication));
}
...
void sys_setFFCShutterMode(LEP_SYS_FFC_SHUTTER_MODE * mode, void * driver)
{
  if (!mode)
    return;
  ((struct lepton_driver*)driver)->communication.sendCommand_array(cmdCode
...
{
  uint32_t status;
  ((struct lepton_driver*)driver)->communication.receiveCommand_u32(cmdCode(LEP_CID_SYS_FFC_STATUS, LEP_I2C_COMMAND_TYPE_GET),
